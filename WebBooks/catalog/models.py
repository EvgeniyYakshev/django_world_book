...
class Author(models.Model):
    ...
    date_of_death = models.DateField(help_text="Введите дату публикации первой книги", verbose_name="Дата публикации первой книги", null=True, blank=True)

    def __str__(self):
        return self.last_name

class Book(models.Model):
    title = models.CharField(max_length=500, help_text="Введите название книги", verbose_name="Название книги")
    ...
    summary = models.TextField(max_length=1500, help_text="Введите краткое описание книги", verbose_name="Аннотация книги")
...
class BookInstance(models.Model):
    ...
    due_back = models.DateField(null=True, blank=True, help_text="Введите конец срока статуса", verbose_name="Дата оканчания статуса")
